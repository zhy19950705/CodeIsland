...
enum SoundPackCatalog {
    ...
    static func discoverPacks(bundle: Bundle = .module, fileManager: FileManager = .default) -> [SoundPack] {
    ...
    static func selectedPack(bundle: Bundle = .module, fileManager: FileManager = .default) -> SoundPack {
    ...
    private static func defaultPack(bundle: Bundle) -> SoundPack {
        ...
        return SoundPack(
            id: defaultPackID,
            title: "8-bit Classic",
            subtitle: "Original CodeIsland notification sounds",
            author: nil,
            accentHex: "#7BC6FF",
