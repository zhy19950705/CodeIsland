...
# Copy the SPM resource bundle into Contents/Resources so the app bundle keeps
# a standard layout and can still be codesigned. Runtime lookup is handled by
# AppResourceBundle.
RESOURCE_BUNDLE=""
for candidate in \
